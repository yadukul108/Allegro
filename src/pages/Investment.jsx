...
const Investment = () => {
  ...
  return (
    <div className='bg-slate-100'>
      <div className="relative w-full h-screen ">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center">
          ...
          <p className="text-3xl md:text-3xl font-medium mt-2">Investment Banking</p>
        </div>
      </div>
   ...
   <div className="w-full max-w-7xl mx-auto px-4 py-12 text-slate-600">
      <h2 className="text-3xl font-bold text-center text-slate-800 mb-10">Transactions</h2>
  ...
  <Link
    to="/transactions"
    className="text-white text-lg font-semibold px-6 py-3 rounded-full bg-gradient-to-r from-red-400 to-red-600 hover:from-red-500 hover:to-red-700 transition duration-300 shadow-md"
  >
    View More
  </Link>
</div>
