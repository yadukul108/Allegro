...
<section className="bg-slate-100 py-16 px-4 md:px-12">
  ...
  <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 max-w-6xl mx-auto">
    ...
    <div className="bg-white shadow-md rounded-2xl p-6 text-center hover:shadow-xl transition">
      ...
      <h3 className="text-xl font-semibold text-slate-800 mb-2">Competitive Salary</h3>
      <p className="text-slate-600">Get paid well for your skills! We offer competitive salary + benefits.</p>
    </div>
    ...
    <div className="bg-white shadow-md rounded-2xl p-6 text-center hover:shadow-xl transition">
      ...
      <h3 className="text-xl font-semibold text-slate-800 mb-2">Collaborative Team</h3>
      <p className="text-slate-600">Work with talented professionals in a growth-focused environment.</p>
    </div>
    ...
    <div className="bg-white shadow-md rounded-2xl p-6 text-center hover:shadow-xl transition">
      ...
      <h3 className="text-xl font-semibold text-slate-800 mb-2">Career Growth</h3>
      <p className="text-slate-600">We support your development with learning, mentorship, and projects.</p>
    </div>
    ...
    <div className="bg-white shadow-md rounded-2xl p-6 text-center hover:shadow-xl transition">
      ...
      <h3 className="text-xl font-semibold text-slate-800 mb-2">Work-Life Balance</h3>
      <p className="text-slate-600">Enjoy flexible hours and a healthy work environment that values you.</p>
    </div>
  </div>
</section>
