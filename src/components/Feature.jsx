...
const FeaturedDealsCarousel = () => {
  ...
  {/* Card Container */}
  <div className="bg-slate-100 pt-4 rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row">
    
    {/* Image */}
    <div className="w-auto mx-auto md:w-2/5 h-64 md:h-auto">
      <img
    ...
    <div className="w-full md:w-3/5 p-6 flex flex-col justify-center">
      ...
      <div className="text-lg text-gray-600 mb-3 flex flex-wrap gap-4">
